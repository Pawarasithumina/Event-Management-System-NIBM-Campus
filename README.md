...
1. Full-stack web application with secure login for admins and students

2. Real-time event registration and management

3. Centralized platform for organizing and tracking campus events

💻 Tech Stack: Node.js, Express, MongoDB Atlas, HTML, CSS, JavaScript
